    ...
    <footer className="mt-auto border-t border-[var(--border)] bg-[var(--paper-elevated)]">
            ...
            <div className="flex flex-wrap gap-3">
              {support.buyMeACoffeeUrl && (
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-button border border-[var(--border-strong)] bg-[var(--paper-elevated)] px-4 py-2 text-sm font-medium text-[var(--ink)] transition-colors hover:bg-neutral-100"
                >
                  Buy me a coffee
                </a>
              )}
      ...
      <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-between gap-4 px-5 py-5 text-sm text-[var(--ink-muted)] sm:px-8">
        ...
        <div className="flex gap-6">
          <Link href="/cv" className="hover:text-[var(--ink)] transition-colors">
            CV
          </Link>
          <Link href="/projects" className="hover:text-[var(--ink)] transition-colors">
            Projects
          </Link>
          <Link href="/papers" className="hover:text-[var(--ink)] transition-colors">
            Papers
          </Link>
          <Link href="/talks" className="hover:text-[var(--ink)] transition-colors">
            Talks
          </Link>
